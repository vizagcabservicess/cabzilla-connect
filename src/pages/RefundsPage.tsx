...
const RefundsPage = () => {
  return (
    <>
      <Helmet>
        <title>Refund Policy - Vizag Taxi Hub | Cancellation & Refund Guidelines</title>
        <meta name="description" content="Understand Vizag Taxi Hub's refund policy for cancellations and service issues. Clear guidelines for refund eligibility, processing time, and refund procedures." />
        <meta name="keywords" content="refund policy vizag taxi hub, cancellation refund, taxi booking refund, refund guidelines" />
        <meta name="author" content="Vizag Taxi Hub" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://vizagtaxihub.com/refunds" />
        ...
        <meta property="twitter:url" content="https://vizagtaxihub.com/refunds" />
        <meta property="twitter:title" content="Refund Policy - Vizag Taxi Hub | Cancellation & Refund Guidelines" />
        <meta property="twitter:description" content="Understand Vizag Taxi Hub's refund policy for cancellations and service issues." />
        <meta property="twitter:image" content="/og-image.png" />
        
        {/* Additional SEO */}
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://vizagtaxihub.com/refunds" />
      </Helmet>
