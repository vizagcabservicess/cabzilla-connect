...
const RentalsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Car Rentals - Vizag Taxi Hub | Self-Drive & Chauffeur-Driven Cars in Visakhapatnam</title>
        <meta name="description" content="Rent cars in Visakhapatnam with Vizag Taxi Hub. Choose from economy sedans to luxury vehicles with self-drive or chauffeur-driven options. Daily, weekly, and monthly rental packages with flexible mileage plans." />
        <meta name="keywords" content="car rental vizag, self drive cars visakhapatnam, car hire, vehicle rental, chauffeur driven cars, daily car rental" />
        <meta name="author" content="Vizag Taxi Hub" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://vizagtaxihub.com/rentals" />
        ...
        <meta property="twitter:url" content="https://vizagtaxihub.com/rentals" />
        <meta property="twitter:title" content="Car Rentals - Vizag Taxi Hub | Self-Drive & Chauffeur-Driven Cars in Visakhapatnam" />
        <meta property="twitter:description" content="Rent cars in Visakhapatnam with Vizag Taxi Hub. Choose from self-drive or chauffeur-driven options." />
        <meta property="twitter:image" content="/og-image.png" />
        
        {/* Additional SEO */}
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://vizagtaxihub.com/rentals" />
      </Helmet>
