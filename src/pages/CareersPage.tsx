...
export default function CareersPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Careers - Join Vizag Taxi Hub Team | Job Opportunities in Visakhapatnam</title>
        <meta name="description" content="Join Vizag Taxi Hub's growing team in Visakhapatnam! We're hiring professional drivers, customer service representatives, and management professionals. Competitive salary, training programs, and career growth opportunities available." />
        <meta name="keywords" content="careers vizag taxi hub, job opportunities visakhapatnam, driver jobs, customer service jobs, taxi company careers, employment vizag" />
        <meta name="author" content="Vizag Taxi Hub" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://vizagtaxihub.com/careers" />
        ...
        <meta property="twitter:url" content="https://vizagtaxihub.com/careers" />
        <meta property="twitter:title" content="Careers - Join Vizag Taxi Hub Team | Job Opportunities in Visakhapatnam" />
        <meta property="twitter:description" content="Join the Vizag Taxi Hub team! Explore exciting career opportunities in Visakhapatnam." />
