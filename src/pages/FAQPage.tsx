...
const FAQPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>FAQ - Frequently Asked Questions | Vizag Taxi Hub</title>
        <meta name="description" content="Get answers to all your questions about Vizag Taxi Hub services. Learn about booking procedures, pricing, cancellation policies, driver information, and safety measures. Comprehensive FAQ for taxi services in Visakhapatnam." />
        <meta name="keywords" content="faq vizag taxi hub, frequently asked questions, taxi booking faq, cab service questions, vizag taxi support" />
        <meta name="author" content="Vizag Taxi Hub" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://vizagtaxihub.com/faq" />
        <meta property="og:title" content="FAQ - Frequently Asked Questions | Vizag Taxi Hub" />
        <meta property="og:description" content="Find answers to frequently asked questions about Vizag Taxi Hub services. Booking, pricing, cancellation, and support information." />
        <meta property="og:image" content="/og-image.png" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://vizagtaxihub.com/faq" />
        <meta property="twitter:title" content="FAQ - Frequently Asked Questions | Vizag Taxi Hub" />
        <meta property="twitter:description" content="Find answers to frequently asked questions about Vizag Taxi Hub services." />
        <meta property="twitter:image" content="/og-image.png" />
        
        {/* Additional SEO */}
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://vizagtaxihub.com/faq" />
      </Helmet>
