...
const TermsPage = () => {
  return (
    <>
      <Helmet>
        <title>Terms & Conditions - Vizag Taxi Hub | Service Terms & Policies</title>
        ...
        <meta property="twitter:title" content="Terms & Conditions - Vizag Taxi Hub | Service Terms & Policies" />
